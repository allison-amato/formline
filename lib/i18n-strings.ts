...
const STRINGS: Record<Lang, Record<string, string>> = {
  en: {
    ...
    "builder.dayLabel": "Day {n}",
    "builder.addDay": "+ Add day",
    "builder.removeDay": "Remove day",
    "builder.removeDayConfirm": "Remove \"{day}\" and its exercises? This can't be undone.",
    "builder.renameDayHint": "Click again to rename",
    "builder.warmup": "Warm-up",
    "builder.warmupRounds": "Rounds",
    "builder.addWarmup": "+ Add warm-up move",
    "builder.addWarmupTitle": "Add a warm-up move",
    "builder.removeWarmupItem": "Remove from warm-up",
    "builder.deleteExercise": "Delete",
    "builder.deleteExerciseConfirm": "Delete this exercise from {day}? This can't be undone.",
  ...
  es: {
    ...
    "builder.dayLabel": "Día {n}",
    "builder.addDay": "+ Agregar día",
    "builder.removeDay": "Eliminar día",
    "builder.removeDayConfirm": "¿Eliminar \"{day}\" y sus ejercicios? Esta acción no se puede deshacer.",
    "builder.renameDayHint": "Haz clic de nuevo para renombrar",
    "builder.warmup": "Calentamiento",
    "builder.warmupRounds": "Rondas",
    "builder.addWarmup": "+ Agregar movimiento de calentamiento",
    "builder.addWarmupTitle": "Agregar un movimiento de calentamiento",
    "builder.removeWarmupItem": "Quitar del calentamiento",
    "builder.deleteExercise": "Eliminar",
    "builder.deleteExerciseConfirm": "¿Eliminar este ejercicio de {day}? Esta acción no se puede deshacer.",
